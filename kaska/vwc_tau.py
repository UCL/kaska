                ...
                for kkkk in field:
                    for k in surface_list:
                        for kk in canopy_list:
                            ...
                            tau = data_field.filter(like='coef').values.flatten() * data_field.filter(like='VWC').values.flatten()
                            ...
                            fig, ax = plt.subplots(figsize=(17, 13))
                            gs = gridspec.GridSpec(6, 1, height_ratios=[5, 5, 5, 5, 5,5])
                            ax = plt.subplot(gs[0])
                            ...
                            ax3.plot(time.values, b, label='b')
                            ...
                            plt.savefig('/media/tweiss/Daten/data_AGU/test_kaska2/tau'+kkkk+'_'+k+'_'+ii+'_n1_s_o', bbox_inches = 'tight')
                            plt.close()
